...
RankNet compliance difference: **-0.26%**; task-bootstrap interval [-0.40%, -0.12%]. Negative favors ranking.
...
|---|---:|---:|
| RankNet | 31.66% | 0.851 |
| Regression (MSE) | 30.94% | 0.848 |
| Regression (log MSE) | 31.48% | 0.847 |
| Evolution without surrogate | 22.15% | 0.054 |
| Random search | 10.17% | 0.041 |

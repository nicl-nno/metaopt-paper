...
RankNet compliance difference: **-0.72%**; task-bootstrap interval [-0.88%, -0.55%]. Negative favors ranking.
...
|---|---:|---:|
| RankNet | 33.74% | 0.844 |
| Regression (MSE) | 33.27% | 0.845 |
| Regression (log MSE) | 33.53% | 0.843 |
| Evolution without surrogate | 23.50% | 0.053 |
| Random search | 10.53% | 0.040 |

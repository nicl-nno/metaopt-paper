...
RankNet compliance difference: **+0.00%**; task-bootstrap interval [+0.00%, +0.00%]. Negative favors ranking.
...
|---|---:|---:|
| RankNet | 11.22% | 0.022 |
| Regression (MSE) | 11.22% | 0.021 |
| Regression (log MSE) | 11.22% | 0.021 |
| Evolution without surrogate | 8.41% | 0.004 |
| Random search | 10.76% | 0.003 |
